...
class AndroidDebugBridge(lb.ShellBackend):
    ...
    def __init__(self, resource: str='NoneType', binary_path: str='str', timeout: str='int'):
        ...
...
if __name__ == '__main__':
    with AndroidDebugBridge() as adb:
        devices = adb.devices()[0][0]
        print(adb.check_airplane_mode(devices))
        adb.set_airplane_mode(devices, 0)
        print(adb.check_airplane_mode(devices))
        adb.push_file(devices, ssmdevices.lib.path('android', 'iperf'), '/data/local/tmp/iperf')
