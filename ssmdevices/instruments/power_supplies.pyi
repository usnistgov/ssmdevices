...
class RigolDP800Series(lb.VISADevice):
    ...
    voltage1 = attr.property.float(
        key=':MEAS:VOLT CH1',
        sets=False,
        help='output voltage reading on channel 1'
    )
    voltage2 = attr.property.float(
        key=':MEAS:VOLT CH2',
        sets=False,
        help='output voltage reading channel 2'
    )
    voltage3 = attr.property.float(
        key=':MEAS:VOLT CH3',
        sets=False,
        help='output voltage reading channel 3'
    )
    current1 = attr.property.float(
        key=':MEAS:CURR CH1',
        sets=False,
        help='current draw reading on channel 1'
    )
    current2 = attr.property.float(
        key=':MEAS:CURR CH2',
        sets=False,
        help='current draw reading on channel 2'
    )
    current3 = attr.property.float(
        key=':MEAS:CURR CH3',
        sets=False,
        help='current draw reading on channel 3'
    )
