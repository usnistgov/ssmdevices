...
class RohdeSchwarzFSWBase(lb.VISADevice):
    ...
    def abort(self) -> None: ...
    def apply_channel_type(self, type_: Optional[Any] = ...) -> None: ...
    def channel_preset(self) -> None: ...
    def query_ieee_array(self, msg: Any): ...
    def fetch_horizontal(
        self, window: Optional[Any] = ..., trace: Optional[Any] = ...
    ): ...
    def fetch_trace(
        self,
        trace: Optional[Any] = ...,
    ...
    def fetch_timestamps(
        self, window: Optional[Any] = ..., all: bool = ..., timeout: int = ...
    ): ...
    ...
    def set_marker_position(self, marker: int, position: float) -> Any: ...
...
class RohdeSchwarzRealTimeMixIn(RohdeSchwarzFSWBase):
    ...
    def set_detector_type(
        self, type_: Any, window: Optional[Any] = ..., trace: Optional[Any] = ...
    ) -> None: ...
    def get_detector_type(
        self, window: Optional[Any] = ..., trace: Optional[Any] = ...
    ): ...
    def set_spectrogram_depth(
        self, depth: Any, window: Optional[Any] = ...
    ) -> None: ...
