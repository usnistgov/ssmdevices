...
def makestub(modname, depth=0):
    ...
    mods = [v for v in toplevel.__dict__.values() if issubmod(v)]
    ...
    for mod in mods:
        ...
        with open(mod.__file__+'i','w', encoding='utf') as pyi:
            ...
            for name, obj in mod.__dict__.items():
                if obj.__class__.__module__.startswith(('labbench', modname)):#inspect.isclass(obj) and issubclass(obj, classes):
