# -*- coding: utf-8 -*-
#
# gpslte documentation build configuration file, created by
# sphinx-quickstart on Tue Aug 30 10:42:09 2016.
#
...
texinfo_documents = [
    (master_doc, '{}-api'.format(project), u'API reference for {}'.format(project),
     author, '{}-api'.format(project), 'instrument automation drivers for shared-spectrum metrology',
     'Miscellaneous'),
]
