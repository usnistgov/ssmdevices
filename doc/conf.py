...
release = project_info['project']['version']
...
exclude_patterns = ["_build", "ssmdevices/_version.py", "ssmdevices/lib", "ssmdevices/etc"]
...
html_title = f"{project} v{project_info['project']['version']}"
